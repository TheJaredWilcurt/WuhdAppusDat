...
const globalConstants = Object.freeze({
  ...
  OUTPUT_FILE_NAME: 'WuhdAppusDat.txt',
  ...
  DEFAULT_BACKGROUND_FLIP_HORIZONTAL: false,
  DEFAULT_BACKGROUND_FLIP_VERTICAL: false,
  ...
  DEFAULT_EXPLAINER_MESSAGE: 'Currently in focus:',
  DEFAULT_EXPLAINER_FONT_FAMILY: 'Petrona',
  DEFAULT_EXPLAINER_FONT_ITALICS: false,
  DEFAULT_EXPLAINER_FONT_SIZE: 16,
  DEFAULT_EXPLAINER_FONT_WEIGHT: 4,
  DEFAULT_EXPLAINER_TEXT_COLOR: '#FFEB3B',
  DEFAULT_EXPLAINER_TEXT_SHADOW: 'black',
  DEFAULT_EXPLAINER_TOP: 37,
  DEFAULT_EXPLAINER_LEFT: 145,
